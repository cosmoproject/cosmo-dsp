...
opcode	Reverse, aa, aaK				;nb. CAPITAL K CREATE A K-RATE VARIABLE THAT HAS A USEFUL VALUE ALSO AT I-TIME
	ainL,ainR,ktime	xin			;READ IN INPUT ARGUMENTS
	...
	rireturn				;RETURN FROM REINITIALISATION PASS
	xout	atapL*aenv, atapR*aenv			;SEND AUDIO BACK TO CALLER INSTRUMENT. APPLY AMPLITUDE ENVELOPE TO PREVENT CLICKS.
endop
...
opcode	Reverse, aa, aa				;nb. CAPITAL K CREATE A K-RATE VARIABLE THAT HAS A USEFUL VALUE ALSO AT I-TIME
	...
	aOutL, aOutR Reverse ainL, ainR, 0.75
	xout aOutL, aOutR
endop
