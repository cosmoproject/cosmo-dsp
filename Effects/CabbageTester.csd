...
rslider bounds(0, 0, 100, 100), channel("P0"), text("Pot 0"), trackercolour("lime"), outlinecolour(0, 0, 0, 50), textcolour("black")
rslider bounds(98, 0, 100, 100), channel("P1"), text("Pot 1"), trackercolour("lime"), outlinecolour(0, 0, 0, 50), textcolour("black")
rslider bounds(196, 0, 100, 100), channel("P2"), text("Pot 2"), trackercolour("lime"), outlinecolour(0, 0, 0, 50), textcolour("black")
rslider bounds(294, 0, 100, 100), channel("P3"), text("Pot 3"), trackercolour("lime"), outlinecolour(0, 0, 0, 50), textcolour("black")
rslider bounds(0, 98, 100, 100), channel("P4"), text("Pot 4"), trackercolour("lime"), outlinecolour(0, 0, 0, 50), textcolour("black")
rslider bounds(98, 98, 100, 100), channel("P5"), text("Pot 5"), trackercolour("lime"), outlinecolour(0, 0, 0, 50), textcolour("black")
rslider bounds(196, 98, 100, 100), channel("P6"), text("Pot 6"), trackercolour("lime"), outlinecolour(0, 0, 0, 50), textcolour("black")
rslider bounds(294, 98, 100, 100), channel("P7"), text("Pot 7"), trackercolour("lime"), outlinecolour(0, 0, 0, 50), textcolour("black")
